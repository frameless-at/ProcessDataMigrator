...
/**
 * Template Creator for Data Migrator
...
class TemplateCreator extends WireData {
    ...
    public function createParentPage($path, $templateName) {
        ...
        // Get or create migration-container template
    ...
    protected function getOrCreateContainerTemplate() {
        $templateName = 'migration-container';
        $template = $this->wire('templates')->get($templateName);
        ...
        $template = $this->wire(new Template());
        $template->name = $templateName;
        $template->label = 'Migration Container';
    ...
    /**
     * Create table-specific parent page under /migration/
     *
     * @param string $path Parent path (e.g., "/migration/customers/")
     * @param Template $template Template for this page
     * @param Page $parent Parent page (usually /migration/)
     * @return Page
     */
 ...
 * Auto-generated by Data Migrator
 *
